 ...
 * @version: 0.0.0.1
 */
public class ExclusiveInclusivegatewaTest {
  ...
  public void deployment() {
    ...
    Deployment deploy =
        repositoryService
            .createDeployment()
            .addClasspathResource("bpmn/evection-inclusivegateway.bpmn") // 添加bpmn资源
            .addClasspathResource("bpmn/evection-inclusivegateway.png") // 添加png资源
            .name("出差申请单-包含网关")
            .deploy();
  ...
  public void startProcessDeploy() {
    ...
    /** 设置流程变量 */
    String key = "evection-inclusivegateway";
  ...
  public void complete() {
    ...
    Task task =
        taskService
            .createTaskQuery()
            .processDefinitionKey("evection-inclusivegateway")
